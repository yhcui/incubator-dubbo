...
public class DubboProtocol extends AbstractProtocol {
    ...
    private void openServer(URL url) {
        ...
        /** 获取是否为服务端即provider,默认为provider端 */
    ...
    /**
     * 用于获取客户端实例，实例类型为 ExchangeClient。
    ...
    private ExchangeClient[] getClients(URL url) {
        ...
        // if not configured, connection is shared, otherwise, one connection for one service. 如果未配置 connections，则共享连接
        if (connections == 0) {
